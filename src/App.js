...
import "./app.scss";
import GrebmeierInput from "./inputs/Grebmeier";
...
function App() {
  ...
  return (
    <div className="app">
      <header className="header">⍼⌰⌱ submit this form and win money ⌱⌰⍼</header>
      <div className="text-center mb-100">
        <p className="text-white">
          The spookiest thing in software is a bad user experience.
        </p>
        <p className="text-white">
          All of these form inputs were created by the frontend team with the
          sole purpose of creating frustration.
        </p>
        <p className="text-white">
          Can you resist being scared away and face the form until the end??
        </p>
        <p className="text-white">
          The first 3 people to submit the form will receive a AmEx gift card!
          Winners will be notified via email and gift cards sent to the address
          supplied in the form. *Exactly 2 submissions per person.
        </p>
        {error && dirty && (
          <p
      ...
      <form name="horror" method="post">
        ...
        <KimInput
          ...
          name1="password"
          name2="password-confirm"
          value={formValues["password"]}
          value2={formValues["password-confirm"]}
          onChange={handleChange}
        />
        <VaznisInput
        ...
        />
        <WilsonInput
          label="Select age (note: value updates after selecting)"
          name="age"
          onChange={handleChange}
        />
        <WellsandtInput
        ...
        />
        <WilliamsInput
          label="Quickly finish the form"
          name="finish-form"
          onChange={handleChange}
          formValid={!error && dirty}
        />
      </form>
    </div>
  );
